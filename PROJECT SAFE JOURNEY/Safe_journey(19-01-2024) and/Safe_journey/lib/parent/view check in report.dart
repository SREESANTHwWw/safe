...
class viewcheckinreport extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const viewcheckinreportfullparent(title: 'Checking Report'),
    );
  }
}

class viewcheckinreportfullparent extends StatefulWidget {
  const viewcheckinreportfullparent({super.key, required this.title});

  final String title;

  @override
  State<viewcheckinreportfullparent> createState() => _view_complaintState();
}

class _view_complaintState extends State<viewcheckinreportfullparent> {
  ...
  void view_complaints() async {
    ...
    try {
      ...
      String url = '$urls/myapp/view_check_in_report_parent/';
